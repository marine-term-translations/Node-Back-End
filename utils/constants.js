...
export const GITHUB_SCOPES =
  "write:packages%20write:repo_hook%20read:repo_hook%20repo";

export const GITHUB_API_VERSION = "2022-11-28";

export const ERROR_MESSAGES = {
  GITHUB_CLIENT_ID_MISSING:
    "GitHub Client ID is missing in the environment variables.",
  ...
  GITHUB_OWNER_MISSING:
    "GitHub organization is not set in environment variables.",
  GITHUB_OWNER_TOKEN_MISSING:
    "GitHub organization token is not set in environment variables.",
  UNAUTHORIZED: "Authorization token is required in the headers.",
  ORG_TOKEN_UNAUTHORIZED:
    "Organization admin token is required in the headers.",
  ...
  TRANSLATION_FIELDS_REQUIRED:
    '"text" and "target" fields are required in the request body.',
